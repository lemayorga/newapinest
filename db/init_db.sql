...
SELECT 'CREATE DATABASE DBSisTemplate1;'
...
-- 	idUser int NOT NULL,
-- 	idRol int NOT NULL,
-- 	CONSTRAINT "PK_usersroles" PRIMARY KEY (id, idUser, idRol)
-- );

-- ALTER TABLE security.usersroles ADD CONSTRAINT "FK_usersroless_rol" FOREIGN KEY (idRol) REFERENCES security.rol(id) ON DELETE CASCADE;
-- ALTER TABLE security.usersroles ADD CONSTRAINT "FK_usersroles_user" FOREIGN KEY (idUser) REFERENCES security.user(id) ON DELETE CASCADE;